...
ConVar tuxui_background_music_duck("tuxui_background_music_duck", "0.15", FCVAR_ARCHIVE);
...
BasePanel::BasePanel(vgui::VPANEL Parent) : BaseClass(nullptr)
{
	...
	g_pVGuiLocalize->AddFile("IVEngine2/IvUI/localization/gameui2_%language%.txt");
...
void BasePanel::UpdateBackgroundMusicVolume(float Volume)
{
	...
	GetGameUI2().GetEngineSound()->SetVolumeByGuid(BackgroundMusicGUID, tuxui_background_music_duck.GetFloat() * Volume);
}
