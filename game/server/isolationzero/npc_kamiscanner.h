...
// Purpose: 
//-----------------------------------------------------------------------------
class CNPC_KamiScanner : public CNPC_BaseScanner
{
	DECLARE_CLASS( CNPC_KamiScanner, CNPC_BaseScanner );
...
protected:
	void			BecomeAssScanner( void ) { m_bIsAssScanner = true; }
...
private:
	...
	bool m_bIsAssScanner;	// Formerly the shield scanner.
